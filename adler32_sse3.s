...
DATA LCPI0_2<>+0x00(SB)/1, $0x10
DATA LCPI0_2<>+0x01(SB)/1, $0x0f
DATA LCPI0_2<>+0x02(SB)/1, $0x0e
DATA LCPI0_2<>+0x03(SB)/1, $0x0d
DATA LCPI0_2<>+0x04(SB)/1, $0x0c
DATA LCPI0_2<>+0x05(SB)/1, $0x0b
DATA LCPI0_2<>+0x06(SB)/1, $0x0a
DATA LCPI0_2<>+0x07(SB)/1, $0x09
DATA LCPI0_2<>+0x08(SB)/1, $0x08
DATA LCPI0_2<>+0x09(SB)/1, $0x07
DATA LCPI0_2<>+0x0a(SB)/1, $0x06
DATA LCPI0_2<>+0x0b(SB)/1, $0x05
DATA LCPI0_2<>+0x0c(SB)/1, $0x04
DATA LCPI0_2<>+0x0d(SB)/1, $0x03
DATA LCPI0_2<>+0x0e(SB)/1, $0x02
...
LBB0_17:
	LONG  $0x000f8f8d; WORD $0xffff // LEAL 0xffff000f(DI), CX              // lea	ecx, [rdi - 65521]
